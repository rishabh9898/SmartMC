...
class SmartMC(models.Model):
	...
	# day_time = models.CharField("Please Enter the time of the day in (Hour : minutes)  format",max_length=50, blank=True, null=True)
	day_time = models.TimeField("Please Enter the time of the day in (Hour : minutes)  format",auto_now=False, auto_now_add=False,null=True)
